...
\begin{flushright}
	...
	\thispagestyle{empty}
	\textit{Prima di fare qualsiasi cosa\\ un bacio.}
	\vspace{\stretch{2}}\null
\end{flushright} 
%FINE DEDICA
...
\chapter{Reti di Hopfield}
	...
	Ogni unità è collegata a tutte le altre attraverso connessioni simmetriche, in termini di pesi sinaptici si ha $w_{i,j} = w_{j,i}$ , $\forall i,j$. Sono quindi reti completamente connesse, in cui non si hanno autoconnession, $w_{i,i}=0$, la cui matrice dei pesi sinaptici è simmetrica e sono ricorrenti. \\
	...
	La rete di Hopfield può essere vista come un sistema dinamico non lineare che evolve verso una configurazione stabile e la stabilità del sistema è strettamente legata ad una \emph{funzione energia}.\\
	...
	Il modello matematico per descrivere le dinamiche di un sistema non lineare è pensato in termini di \textbf{variabili di stato}. Tali variabili rendono possibile prevedere l'evoluzione del sistema a partire da un certo istante temporale utilizzando i valori che sono associati ad esse, poiché considerati sufficienti per la previsione dell'evoluzione.\\
	Definiamo \textbf{vettore di stato}:\\
	...
	\clearpage Tale funzione assume questa forma:
	...
	Tale funzione è limitata inferiormente ed assumendo un aggiornamento di tipo asincrono, essa risulta strettamente monotona decrescente lungo una qualsiasi traiettoria descritta dalla rete di Hopfield nello spazio di stato:
	...
	La (3.11) è sempre positiva, infatti:
...
%caso continuo
%situazione vettoriale con esempio


%\phantomsection 
\begin{thebibliography}{9} 
	\addcontentsline{toc}{chapter}{\refname}
	\bibitem[1]{Bicego} Prof. Bicego Manuele, \emph{Riconoscimento e recupero dell’informazione per bioinformatica, reti neurali}
	\bibitem[2]{Gambosi} Prof. Gambosi Giorgio, \emph{Reti neurali, note dal corso di Machine Learning}, (2010), Packt Publishing 
	\bibitem[3]{GarretaMoncecchi} Garreta Raùl, Moncecchi Guillermo, \emph{Learning scikit-learn:Machine Learning in Python}, (2013) 
	\bibitem[4] {Labonia} Prof.ssa Labonia Laura, \emph{Storia delle reti neurali artificiali}
	\bibitem[5]{Lazzarini} Prof.ssa Lazzarini Beatrice, \emph{Introduzione alle reti neurali}, (2015)
	\bibitem[6] {Pioggia} Ing. Pioggia Giovanni, \emph{Modelli di sistemi fisiologici}, (2009)
 \end{thebibliography}
