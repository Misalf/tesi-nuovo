...
\chapter{Reti di Hopfield}
	...
	\begin{itemize}
		\item\textbf{\emph{aggiornamento asincrono}} in cui si aggiorna un neurone alla volta;
		\item\textbf{\emph{aggiornamento sincrono}} in cui tutti i neuroni sono aggiornati nello stesso istante;
		\item\textbf{\emph{aggiornamento continuo}} in cui tutti i neuroni si aggiornano continuamente.
	\end{itemize}
	...
	Supponiamo di voler memorizzare il set di stati $v^ {s}$ con $s = 1, ..., n$.\\
