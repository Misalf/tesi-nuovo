...
\begin{document}
	...
	\begin{flushright} 
		...
		\thispagestyle{empty}
		\textit{``Er cavaliere nero e er cavaliere bianco vanno a duello! \\
		Mo ce sta er cavaliere nero che t'ammazza il cavaliere bianco. \\
		Il cavaliere bianco c'aveva tre fiji: tutti sti tre fiji sfidano er cavaliere nero\\
		ma er cavaliere nero t'ammazza tutti e tre.\\
		Mo sti tre fiji c'avevano tre fiji per uno: \\
		Tutti e nove te sfidano er cavaliere nero \\
		ma er cavaliere nero t'ammazza tutti e nove.\\
		Sti tre cavalieri bianchi c'avevano tre fiji per uno:\\
		tutti e ventisette te sfidano er cavaliere nero \\
		ma er cavaliere nero t'ammazza tutti e ventisette!
		Mo sti ventisette cavalieri bianchi c'avevano..."\\
		\vspace{1cm}
		``E BASTA! Dimmi la morale di questa favola!"\\
		\vspace{1cm}
		``A morale della favola? \\E' che ar cavaliere nero non je devi cacà er cazzo!"}
		\vspace{\stretch{2}}\null
	\end{flushright} 
   	%FINE DEDICA
